    ...
    <Container>
      ...
      <div className='intro page-section'>
          ...
          <div className='intro-text left-0 text-center bg-faded p-5 rounded'>
            ...
            <div className='intro-button mx-auto'><a className='btn btn-primary btn-xl' data-toggle='modal' data-target='#registerModal' id='registerButton'>Register Today!</a></div>
          </div>
      </div>
      </Row>
    </Container>
